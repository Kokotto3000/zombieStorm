...
export default class Weather{
    ...
    createAudio(){
        // thunder= new Audio("../../assets/sound/thunder.mp3");
        // this.thunder.src
    ...
    flash(){
        setTimeout(()=> {
            ...
            if(this.sound) thunderSound.play();
            setTimeout(()=> this.app.stage.removeChild(this.lightning), 200);
            this.flash();
        }, this.lightningGap.min + (this.lightningGap.max - this.lightningGap.min) * Math.random());
        // this.app.stage.addChild(this.lightning);
